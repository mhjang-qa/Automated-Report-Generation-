...
- `FIGMA_ACCESS_TOKEN`: Pixel Perfect QA 탭에서 Figma Frame PNG를 생성할 때 사용합니다. 프론트엔드에는 노출하지 않습니다.
...
상단 `Pixel Perfect QA` 탭에서 Figma 디자인과 실제 웹 화면을 같은 viewport에 배치해 비교할 수 있습니다.
